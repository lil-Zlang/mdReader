// Demo data for Vercel deployment where API may not be available

export const isVercelProduction = typeof window !== 'undefined' &&
...
export function getDemoFileContent(fileId: string): { content: string; metadata: any } | null {
